/**
 * Pointer module — NaN-boxing and bump allocator.
 *
...
export default () => {
  ...
  ctx.funcs.push({ name: '_alloc', body: null, exported: true, sig: { params: [{ name: 'bytes', type: 'i32' }], results: ['i32'] }, raw: '(func (export "_alloc") (param $bytes i32) (result i32) (call $__alloc (local.get $bytes)))' })
  ctx.funcs.push({ name: '_reset', body: null, exported: true, sig: { params: [], results: [] }, raw: '(func (export "_reset") (call $__reset))' })
